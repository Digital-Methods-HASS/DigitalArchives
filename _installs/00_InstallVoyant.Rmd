...
In order to fully participate in workshops on Thursday and Friday in week 36, you need to have downloaded *Stadsarkivet data* from the class shared drive (only reachable via eduroam on campus), and the *Voyant server* desktop software. Both downloads will take time, so do this in advance and if in difficulty, sign up for a slot with one of our assistants by Monday 5 pm in week 36. 
