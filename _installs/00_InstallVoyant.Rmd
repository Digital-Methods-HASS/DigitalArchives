...
In order to fully participate in the Voyant workshops in Week 35, you need to have access to the *Stadsarkivet and Stiften datasets* from the class Shared Drive (reachable via eduroam on campus or from home via VPN), and the *Voyant server* desktop software. Both the data and the software are large, so do the installation in advance. If you struggle with software or data, sign up for a slot with our HelpDesk during Monday or Tuesday in Week 35. The signup links will be circulated during the first day of class. 
...
4. Double click the `VoyantServer.jar` file. When you open this file a new window (see image below) will pop up with numerous server controls. If you are curious about what these all mean you can read about the options in the documentation for the Voyant Server. However, in short, this window begins to launch a server which will generate the Voyant tools interface.
...
- Once you have selected the file, click *Open* and Voyant will upload the file and direct you to the dashboard. This may take a few seconds to a few minutes depending on your computer's performance and the memory you allocated to Voyant (and the size of the corpus of documents). 
...
We will cover these topics in the hands-on session in week 35. 
...
---
Credits:
This guide has been inspired by [Amanda Regan](https://www.amanda-regan.com/Workshop-UCR/) and tested and improved by Antonio Rivero Ostoic and Josephine Moeller Jensen.
