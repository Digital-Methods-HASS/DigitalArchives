...
- [VOYANT](https://github.com/sgsinclair/VoyantServer/releases/tag/2.4.0-M45): This is a rather large download [~450Mb], requiring solid internet connection. Remember to scroll down this webpage and click on the `.zip` file to download.


- DATASETS sit on Shared drive:ARTS_DigitalArchives2021. About the process of their creation and curation, please read the handouts on Brightspace. The Aarhus Stadtsarkivet minutes contain the entirety of the minutes filed during 1939-1945. The Aarhus Stiftstidende contains the same timespan of newspapers.  Please, get on  eduroam or, if working from home, on [VPN](https://studerende.au.dk/en/it-support/vpn/) and [shared drive ](https://studerende.au.dk/fileadmin/studerende.au.dk/ST/diplomingenior/Filer/Studievejledning/itguide_til_nye_studerende.pdf) to download all of the datasets on your computer. The data is NOT in public domain *yet* and under no conditions should you circulate or disseminate it online, or outside the present class. If you violate this rule, you will be liable for breaching the AU code of conduct and the privacy law in Denmark. 
