...
2. Download Voyant Server (from [Github](https://github.com/sgsinclair/VoyantServer/releases/tag/2.4.0-M45) by navigating down the page and clicking the *VoyantServer2_4-M45.zip* file (If the download doesn’t work for you, sign up for assistant session, they will have the file on a flash drive)
