...
Discuss in your group whether you have ever encountered these terms: `metadata standards`, `unique identifiers`, `customizable attributes/tags`, and `controlled vocabularies`. (You should have encountered some in the previous tutorial.) What do you think they refer to?  Find the team-member who is in Helle's TOM class and has been introduced to Tropy and have them elaborate these concepts in the context of Tropy. 
</font color>
