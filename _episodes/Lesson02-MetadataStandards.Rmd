...
What a nice if random description. Create one of your own now! Feel free to differ in your defining characteristics. 
These expressions are understandable to our human eyes and brains, but too wordy for a computer. For a computer to understand who Adela is you might convert it to a table or use tags to mark the important meaningful parts of the sentences.
...
library(xtable)
Identifier <- "adela@cas.au.dk"
Name <- "Adela"
Contributor <- "Parent 1, Parent 2"
Date <- as.integer(1979)
FavoriteBook <- "Snowcrash"
me <- data.frame(Identifier, Name, Contributor, Date, FavoriteBook)
print(xtable(me), type = "html")
```

Ok. This table classifies and organizes the information for a computer with a spreadsheet programme. But, what if you are exchanging this data among different computing systems that don't all have the same programmes? You can also tag the meaningful information.
