...
Let's say you are concerned about the effects of industrialisation on public health and wish to know the trends in accidents over the last 150 years, through time and space in Australia. 
...
[Lists](https://trove.nla.gov.au/help/become-voluntrove/lists) are another way that Trove users can create their own collections. They’re simply groups of resources on a particular topic. Here’s a short [video](https://youtu.be/lcHL1EDtNlE) for Trove volunteers describing how to use them:
