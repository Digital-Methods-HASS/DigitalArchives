...
- Complete the steps below and the set of activities and post the answers in your GoogleFolder or in Zoom/Mentimeter polls.


## Collectors and collections
### Introducing Trove
Let’s start our exploration by looking at Trove, the principal public digital collection of Australia.
...
- Find the ‘Images, maps, artefacts’ category or results box and click on it to focus on results from the Trove pictures zone. (There’s more about Trove’s zones here.)
- Let’s refine our results using facets. Under ‘Refine your results’ on the right hand side, click ‘Artefact’ under Format. What happens?
...
Let's say you are concerned about the effects of industrialisation on public health, and are interested in knowing the trend in accidents through the last 150 years, through time and space in Australia. 
...
- Let’s refine our results using facets. Under ‘Refine your results’ on the right hand side or the bottom of the page, click ‘Date range’. What happens? Click 'Show more' at the bottom.
...
Along the way, however, the word ‘curator’ has taken a bit of a battering. Watch this [video](https://vimeo.com/87716505) and if you can access it, read this short article – [‘All curators now’](https://www.1843magazine.com/content/ideas/anthony-gardner/all-curators-now):
...
- Go to Trove and search on ‘tags’. Here there used to be a list of the most popular tags added by users to items in Trove.
- Look for ‘LRRSA’. What do you think it means? [this no longer exists in September 2020, sadly, so take a guess or search on this tag]
...
[Lists](https://trove.nla.gov.au/help/become-voluntrove/lists) are another way that Trove users can create their own collections. They’re simply groups of resources on a particular topic. Here’s a short [video](https://youtu.be/lcHL1EDtNlE) describing how to use them:

## Making your own Trove collection (Optional for those interested in learning more :)
...
- You’re welcome to create a list on any topic that interests you. If inspiration fails, how about choosing a random example and documenting the amazing history of butter in Australia?
...
Once you’re done, share a link to your list on GDrive.
...
It’s easy to turn your list into an exhibition, just follow [these instructions](https://github.com/wragge/diy-trove-exhibition). Have a go and share the results on GDrive.
