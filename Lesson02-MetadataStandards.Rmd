...
Example: Adela is a person, her parents produced her in 1979.


*Step 2. Take that sentence and convert it to a table*


|Identifier | Title | Contributor | Date
|-----------|-------|-------------|----------|
|adela@cas.au.dk | Adela | Parent 1, Parent 2 | 1979|
...
*Step 4. Convert this to Dublin core standard*
    ...
    <record>
       ...
       <dc:description<Stuff</dc:description>
...
*Step 5. Consult with your group*
...
- Think about what you might need to do to maintain consistency across your descriptions 
